/**
 * ISO 3166-1 alpha-2 codes - the same 249 that create_lead / update_lead / enrich_lead accept in mcp.json.
...
/** Codes sorted by their display name, for pickers. */
export const COUNTRY_OPTIONS = [...COUNTRY_CODES].sort((a, b) => countryName(a).localeCompare(countryName(b)))
